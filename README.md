...
- Google Analytics 4 qua `@next/third-parties`
...
Đặt GA4 Measurement ID trong `.env.local` để bật Google Analytics:

```bash
NEXT_PUBLIC_GA_MEASUREMENT_ID="G-XXXXXXXXXX"
```

Nếu biến này để trống, ứng dụng không tải script GA.
